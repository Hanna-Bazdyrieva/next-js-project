          ...
          <ul className="team__list">
            <li className="team__card">
              ...
              <div className="team__details">
                ...
                <p className="team__job" lang="en">Product Designer</p>
              </div>
            ...
            <li className="team__card">
              ...
              <div className="team__details">
                ...
                <p className="team__job" lang="en">Frontend Developer</p>
              </div>
              <ul className="socials team__socials">
                <li className="socials__item">
                  <a href="" className="socials__link">
            ...
            <li className="team__card">
              ...
              <div className="team__details">
                ...
                <p className="team__job" lang="en">Marketing</p>
              </div>
              <ul className="socials team__socials">
                <li className="socials__item">
                  <a href="" className="socials__link">
            ...
            <li className="team__card">
              ...
              <div className="team__details">
                ...
                <p className="team__job" lang="en">UI Designer</p>
              </div>
              <ul className="socials team__socials">
                <li className="socials__item">
                  <a href="" className="socials__link">
